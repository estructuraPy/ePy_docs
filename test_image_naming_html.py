#!/usr/bin/env python3
"""
Test image naming standardization - HTML only.
"""
...
def test_image_naming():
    ...
    # Generate only HTML to avoid font issues
    paths = writer.generate(output_filename="test_image_naming", html=True, pdf=False)
    
    print("Generated paths:")
    print(paths)
    
    # Look for all files created
