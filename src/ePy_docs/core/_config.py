...
# Import path utilities from extracted module
from ._paths import get_caller_directory, get_absolute_output_directories
...
class ModularConfigLoader:
    ...
    def load_external(self, config_name: str) -> Dict[str, Any]:
        ...
        # Special case: colors.epyson and translations.epyson live in config/assets/ directory
        if config_name in ['colors', 'translations']:
            package_root = self.config_dir.parent
            external_path = package_root / 'config' / 'assets' / f'{config_name}.epyson'
